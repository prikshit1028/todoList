...
class create{
    ...
    time(t = this.duedate){
        ...
        alert(`Hey you have${hoursleft} hours left to do this task!`)
...
window.addProject = function(something){
...
window.deleteTask = function(projectname,indexnumber){
